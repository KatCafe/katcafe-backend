...
export default class Comment extends CommentModel {
    ...
    constructor( slug, topic, channel, uuid, body ='', link = '', preview, isAnonymous = false, owner, country = '', ip='', date = new Date().getTime() ){
        super(slug, topic, channel, uuid, body, link, preview, isAnonymous, owner, country.toLowerCase(), ip.toLowerCase(), date);
    }
