...
class Sitemap{
    ...
    async sitemapCreated(){
        ...
        if (!consts.DEBUG){
            ...
            console.log('pinging request:', 'https://google.com/webmasters/tools/ping?sitemap='+encodeURI(url));
            await NetworkHelper.get('https://google.com/webmasters/tools/ping?sitemap='+encodeURI(url), );
        }
